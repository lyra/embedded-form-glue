...
var Glue = /*#__PURE__*/function () {
  ...
  _createClass(Glue, [{
    ...
    value: function loadLibrary(domain, publicKey) {
      var formToken = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
      var hasErrors = false;
      ...
      if (!/^(?:http(s)?:\/\/)?[\w.-]+(?:\.[\w.-]+)+[\w\-._~:/?#[\]@!$&'()*+,;=.]+$/g.test(domain)) {
        hasErrors = true;
    ...
    value: function loadKryptonClient() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        script.src = "".concat(domain, "static/js/krypton-client/V4.0/stable/kr-payment-form.min.js");
        ...
        (0, _whenDefined.default)(window, 'KR', function () {
          (0, _whenDefined.default)(window.KR, 'onFormReady', function () {
            resolve({
              KR: window.KR
            });
          });
